    ...
    <section className="py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 space-y-4">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground">¿Cómo elegir tu chimenea ideal?
            <span className="text-gradient">chimenea ideal</span>?
          </h2>
        ...
        <div className="text-center mt-12">
          <Link
            to="/contacto"
            className="inline-flex items-center gap-2 text-primary font-medium hover:underline underline-offset-4 rounded-md font-sans text-xl">
